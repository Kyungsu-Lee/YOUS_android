...
public class Activity_Start extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.setBackground(getResources().getDrawable(R.drawable.yous_loading));
        logo.setLayoutParams(new YousParameter(66, 89).addRules(RelativeLayout.CENTER_IN_PARENT));
        main.addView(logo);
