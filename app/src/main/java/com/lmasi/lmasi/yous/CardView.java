...
public class CardView extends RelativeLayout {
    ...
    public CardView(final Context context, String title, String subTitle, int index, int color, String agree, String disagree, final String aContent, final String dContent) {
        super(context);
        ...
        this.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_UP)
                {
                    ...
                    YousResource.title = CardView.this.title;
                    YousResource.index = CardView.this.index;
                    YousResource.title_agree = CardView.this.agree;
                    YousResource.title_disagree = CardView.this.disagree;
                    YousResource.circle_agree = aContent;
                    YousResource.circle_disagree = dContent;
