...
public class Activity_Agree extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  title = "贊";
        ...
        titleTextView.setTextSize(90);  //125, 한글은 90으로
        ...
        RelativeLayout btn_disagree = new RelativeLayout(getApplicationContext());
        btn_disagree.setLayoutParams(new YousParameter(185, 185)
                                        .setMargin(750 - 185/2, 1333 * 2/ 4 + 100, -1000, -1000)
        );
        btn_disagree.setPadding(0, 0, 185/2, 0);
        btn_disagree.setBackground(getResources().getDrawable(R.drawable.circle_red));
        ...
        tv.setText(YousResource.circle_disagree);
        tv.setTextSize(70);
        tv.setLayoutParams(new YousParameter(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT)
                .addRules(RelativeLayout.CENTER_VERTICAL)
                .setMargin(0, 0, 20, 0)
        );
        tv.setTextColor(Color.parseColor("#F2F2F2"));
        tv.setTypeface(YousResource.KOPUB_MID);
        tv.setGravity(Gravity.CENTER);
        btn_disagree.addView(tv);
...
*/
        ...
        ImageReferenceBox imageReferenceBox = new ImageReferenceBox(getApplicationContext(), index, true);
        imageReferenceBox.setLayoutParams(new YousParameter(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT)
                .addRules(RelativeLayout.BELOW, referenceBox.getId())
        );
        scrollView.addView(imageReferenceBox);
    ...
    public void onBackPressed() {
            startActivity(new Intent(this, Activity_Summary.class).putExtra("title", title).putExtra("index", index).putExtra("agree", title_agree)
                .putExtra("disagree", title_disagree)
            );
        overridePendingTransition(R.anim.slide_right, R.anim.slide_in_right);
            finish();
