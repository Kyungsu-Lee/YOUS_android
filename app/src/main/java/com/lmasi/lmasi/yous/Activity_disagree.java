...
*/
        ...
        RelativeLayout btn_agree = new RelativeLayout(getApplicationContext());
        btn_agree.setLayoutParams(new YousParameter(185, 185)
                .setMargin(-185/2, 1333 * 2/ 4 + 100, -1000, -1000)  //- 185/2
        );
        btn_agree.setPadding(185/2, 0, 0, 0);
        btn_agree.setBackground(getResources().getDrawable(R.drawable.circle_blue));
        ...
        tv.setText(YousResource.circle_agree);
        tv.setTextSize(70);
